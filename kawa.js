...
(function() {
  var EventEmitter, Kawa, MergeStream, WaiterStream, chunk, extend, p1, p2,
  ...
  EventEmitter = (function() {
    ...
    EventEmitter.prototype.triggerChange = function(v) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ev = _ref[_i];
        _results.push(ev(v != null ? v : this._val));
      }
      return _results;
    };
  ...
  Kawa.Stream = (function() {
    ...
    Stream.prototype.reset = function(_val) {
      this._val = _val;
  ...
  Kawa.Junction = (function() {
    extend(Junction.prototype, EventEmitter.prototype);

    function Junction(initial, props) {
      var key, s, streams;
      this.props = props;
      this._val = initial;
      this.disposed = false;
      ...
      this._merger = Kawa.merge(initial, streams, (function(_this) {
        return function() {
          return _this.triggerChange(_this.value());
        };
      })(this));
    }
    ...
    Junction.prototype.value = function() {
      var k, obj, v, _ref;
      obj = {};
      _ref = this.props;
      for (k in _ref) {
  ...
  chunk.onChange(function(v) {
    return console.log('chunk', v);
  });
